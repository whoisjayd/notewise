...
def main(ctx: typer.Context) -> None:
    ...
    if ctx.invoked_subcommand is None:
        ...
        console.print(
            '  [cyan]yt-study process "https://youtube.com/watch?v=ID"[/cyan]'
        )
        console.print(
            '  [cyan]yt-study process "https://youtube.com/playlist?list=ID"[/cyan]'
        )
        console.print("  [cyan]yt-study process urls.txt[/cyan]")
        console.print()
        ...
        console.print()
        console.print(
            "[dim]Run [cyan]yt-study COMMAND --help[/cyan] for command details.[/dim]"
        )
...
def stats(
    ...
    from yt_study.cli._admin import render_stats
...
def history(
    ...
    from yt_study.cli._admin import render_history
...
def info(
    ...
    console = _get_console()
    if url is None:
        from yt_study.cli._admin import render_runtime_info
    ...
    _load_process_dependencies()
    settings = _get_config()
    from yt_study.cli._admin import render_source_info
    from yt_study.cli._formatters import print_single_failure
    from yt_study.errors import PlaylistError, ValidationError, VideoUnavailableError
    ...
    try:
        ...
        print_single_failure(
            console,
            "Unexpected Error",
            "yt-study could not inspect this source. "
...
def doctor() -> None:
    ...
    from yt_study.cli._admin import render_doctor
...
def edit_config() -> None:
    ...
    from yt_study.cli._admin import edit_config as open_config_in_editor
...
def cache_info() -> None:
    ...
    from yt_study.cli._admin import render_cache_info
...
def cache_show(
    ...
    from yt_study.cli._admin import render_cache_entry
...
def cache_clear(
    ...
    console = _get_console()
    from yt_study.cli._admin import clear_cache
...
def cache_prune(
    ...
    from yt_study.cli._admin import prune_cache
...
def logs(
    ...
    if ctx.invoked_subcommand is not None:
        return
    from yt_study.cli._admin import render_logs
...
def logs_clean(
    ...
    """Prune old log files."""
    from yt_study.cli._admin import clean_logs
