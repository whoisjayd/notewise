...
class StudyMaterialGenerator:
    ...
    def _chunk_transcript(self, transcript: str) -> List[str]:
        ...
        logger.info(f"Transcript too long ({token_count:,} tokens), performing chunking...")
    ...
    def _update_status(
        ...
        if progress and task_id is not None:
            ...
            progress.update(task_id, description=f"[yellow]{short_title}[/yellow]: {message}")
        else:
    ...
    async def generate_study_notes(
        ...
        self._update_status(progress, task_id, video_title, f"Generating notes for {len(chunks)} chunks...")
        ...
        self._update_status(progress, task_id, video_title, f"Combining {len(chunk_notes)} chunk notes...")
    ...
    async def generate_chapter_based_notes(
        ...
        self._update_status(progress, task_id, video_title, f"Generating notes for {len(chapter_transcripts)} chapters...")
        ...
        self._update_status(progress, task_id, video_title, "Combining chapter notes...")
