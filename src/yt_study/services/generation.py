...
from yt_study.infrastructure.llm.prompts.chapter_notes import (
    get_chapter_prompt,
    get_combine_chapters_prompt,
)
from yt_study.infrastructure.llm.prompts.quiz import (
    QUIZ_SYSTEM_PROMPT,
    get_quiz_combine_prompt,
    get_quiz_prompt,
)
from yt_study.infrastructure.llm.prompts.study_notes import (
    SYSTEM_PROMPT,
    get_chunk_prompt,
    get_combine_prompt,
    get_single_pass_prompt,
)
from yt_study.infrastructure.llm.provider import LLMProvider
