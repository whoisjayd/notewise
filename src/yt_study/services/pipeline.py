...
from yt_study.infrastructure.youtube.metadata import get_video_metadata  # noqa: F401
...
from yt_study.services.artifacts import export_transcript, generate_and_write_quiz
from yt_study.services.helpers import (
    coerce_usage_float,
    coerce_usage_int,
    coerce_usage_totals,
...
from yt_study.services.state import PipelineSharedState, dedupe_video_ids
...
class CorePipeline:
    ...
    async def _process_single_video(
        ...
        from yt_study.services.execution import process_single_video as _impl
    ...
    async def run(
        ...
        from yt_study.services.execution import run_pipeline as _impl
