...
CONFIG_DB_FILENAME = "config.db"
CONFIG_SETTINGS_TABLE_NAME = "settings"
CONFIG_ENDPOINTS_TABLE_NAME = "custom_endpoints"
CONFIG_API_KEYS_TABLE_NAME = "api_keys"
...
OPENAI_REASONING_MODEL_PATTERN = r"(^|/)(o1|o3|o4)([-_/]|$)"
...
PROVIDER_CONFIG: dict[str, dict[str, Any]] = {
    ...
    "ai21": {
        ...
        "api_url": "https://studio.ai21.com/account/api-key",
        "keywords": ["ai21", "jamba"],
        "litellm_providers": ["ai21"],
    },
    "cerebras": {
        "name": "Cerebras",
        "auth_type": AUTH_TYPE_API_KEY,
        "env_var": "CEREBRAS_API_KEY",
        "api_url": "https://cloud.cerebras.ai/",
        "keywords": ["cerebras"],
        "litellm_providers": ["cerebras"],
    },
    "cloudflare": {
        "name": "Cloudflare Workers AI",
        "auth_type": AUTH_TYPE_API_KEY,
        "env_var": "CLOUDFLARE_API_KEY",
        "api_url": "https://dash.cloudflare.com/profile/api-tokens",
        "keywords": ["cloudflare", "workers-ai"],
        "litellm_providers": ["cloudflare"],
    },
    "dashscope": {
        ...
        "litellm_providers": ["dashscope"],
    },
    "deepinfra": {
        "name": "DeepInfra",
        "auth_type": AUTH_TYPE_API_KEY,
        "env_var": "DEEPINFRA_API_KEY",
        "api_url": "https://deepinfra.com/dash/api_keys",
        "keywords": ["deepinfra"],
        "litellm_providers": ["deepinfra"],
    },
    "huggingface": {
        "name": "Hugging Face",
        "auth_type": AUTH_TYPE_API_KEY,
        ...
        "litellm_providers": ["huggingface"],
    },
    "jina_ai": {
        "name": "Jina AI",
        "auth_type": AUTH_TYPE_API_KEY,
        "env_var": "JINA_API_KEY",
        "api_url": "https://jina.ai/api-dashboard/",
        "keywords": ["jina"],
        "litellm_providers": ["jina_ai"],
    },
    "novita": {
        "name": "Novita AI",
        "auth_type": AUTH_TYPE_API_KEY,
        "env_var": "NOVITA_API_KEY",
        "api_url": "https://novita.ai/settings/key-management",
        "keywords": ["novita"],
        "litellm_providers": ["novita"],
    },
    "nvidia_nim": {
        "name": "NVIDIA NIM",
        "auth_type": AUTH_TYPE_API_KEY,
    ...
    "replicate": {
        ...
        "keywords": ["replicate"],
        "litellm_providers": ["replicate"],
    },
    "sambanova": {
        "name": "SambaNova",
        "auth_type": AUTH_TYPE_API_KEY,
        "env_var": "SAMBANOVA_API_KEY",
        "api_url": "https://cloud.sambanova.ai/apis",
        "keywords": ["sambanova"],
        "litellm_providers": ["sambanova"],
    },
    "voyage": {
        "name": "Voyage AI",
        "auth_type": AUTH_TYPE_API_KEY,
        "env_var": "VOYAGE_API_KEY",
        "api_url": "https://dash.voyageai.com/api-keys",
        "keywords": ["voyage"],
        "litellm_providers": ["voyage"],
    },
    "vercel_ai_gateway": {
        "name": "Vercel AI Gateway",
        "auth_type": AUTH_TYPE_API_KEY,
        "env_var": "VERCEL_AI_GATEWAY_API_KEY",
        "api_url": "https://vercel.com/docs/ai-gateway",
        "keywords": ["vercel"],
        "litellm_providers": ["vercel_ai_gateway"],
    },
    "github_copilot": {
        "name": "GitHub Copilot",
...
SETUP_MODEL_SELECTION_PAGE_SIZE = 20
...
LITELLM_LOG_ENV_VAR = "LITELLM_LOG"
LITELLM_LOG_DEFAULT_LEVEL = "ERROR"
...
PDF_UNSUPPORTED_UNICODE_ERROR = (
    "PDF output does not yet support {target_language} script text. "
    "Use Markdown, HTML, or DOCX for {target_language} output."
)
PDF_RENDER_FALLBACK_WARNING = (
    "PDF rendering failed for this video; a Markdown file was generated instead. "
    "Use HTML or DOCX if you need a rendered document."
)
PDF_FONT_FAMILY = "NotoSans"
PDF_FONT_FILENAMES: dict[str, str] = {
