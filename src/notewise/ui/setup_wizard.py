...
def save_config(
    ...
    *,
    ...
    # Create the file owner-only from the start (no world-readable window)
    # instead of touch-then-chmod.
    config_fd = os.open(
        config_path, os.O_CREAT | os.O_WRONLY | os.O_TRUNC, CONFIG_FILE_PERMISSION_MODE
    )
    ...
    # Reinforce restrictive permissions after writing.
    config_path.chmod(CONFIG_FILE_PERMISSION_MODE)
