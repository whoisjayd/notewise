...
class TestPipelineOrchestrator:
    ...
    def orchestrator(self, temp_output_dir, mock_llm_provider):
        with patch(
            "yt_study.core.orchestrator.get_provider",
    ...
    async def test_process_video_single(self, orchestrator):
        ...
        with (
            patch(
                "yt_study.core.orchestrator.get_video_title",
                return_value="Test Video",
            ),
            patch("yt_study.core.orchestrator.get_video_duration", return_value=100),
            patch("yt_study.core.orchestrator.get_video_chapters", return_value=[]),
            patch(
                "yt_study.core.orchestrator.fetch_transcript",
    ...
    async def test_process_video_with_chapters(self, orchestrator):
        ...
        with (
            ...
            patch("yt_study.core.orchestrator.get_video_duration", return_value=4000),
            patch(
                "yt_study.core.orchestrator.get_video_chapters",
                return_value=["chap1"],
            ),
            patch(
                "yt_study.core.orchestrator.fetch_transcript",
            ...
            patch(
                "yt_study.core.orchestrator.split_transcript_by_chapters",
    ...
    async def test_run_video_flow(self, orchestrator):
        ...
        with (
            patch("yt_study.core.orchestrator.parse_youtube_url") as mock_parse,
            patch.object(
