...
description: Test suite structure, conventions, and how to write good tests for yt-study.
icon: flask-conical
---
...
def test_fetch_transcript(mocker):
    mock_fetch = mocker.patch(
        "yt_study.youtube.transcript.fetch_transcript",
...
async def test_pipeline_run(mocker):
    mocker.patch("yt_study.pipeline._execution.fetch_transcript", ...)
