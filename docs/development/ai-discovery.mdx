...
description: Maintain llms.txt and skill.md so agents can reliably discover and use yt-study docs.
icon: bot
---
...
| `docs/skill.md` | Operational guidance for coding agents helping with yt-study workflows |
...
yt-study itself is a CLI, not an MCP server. For MCP-enabled workflows, expose these docs through your existing docs hosting and indexing pipeline so agents can retrieve up-to-date command and reference content.

<CardGroup cols={2}>
  <Card title="Documentation Guide" icon="book-open" href="/development/documentation">
    Full contributor playbook including navigation and content standards.
  </Card>
  <Card title="CI/CD" icon="git-branch" href="/development/ci-cd">
