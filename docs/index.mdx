...
**NoteWise** is a command-line tool that turns YouTube content into comprehensive Markdown study notes — powered by the LLM of your choice, with no browser required.
