...
notewise routes all LLM calls through [LiteLLM](https://github.com/BerriAI/litellm), which means any model LiteLLM supports can be used with the `--model` flag or the `DEFAULT_MODEL` config key.
