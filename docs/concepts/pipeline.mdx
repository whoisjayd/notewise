...
description: How yt-study processes a video — step by step.
icon: workflow
---

Every video yt-study processes goes through the same sequence. Understanding the pipeline helps you predict output behavior, tune concurrency, and debug problems.
...
yt-study uses `asyncio` throughout.
