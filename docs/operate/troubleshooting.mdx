...
| Free-tier daily quota exhausted | Error message   | NoteWise distinguishes this from an ordinary rate limit. Waiting won't help until the next day — switch to a different (often paid) model, or add credits with the provider. |
