...
export function Hero({ stats }: { stats: RepoStats }) {
  return (
    <section className="relative overflow-hidden pt-24 pb-20 sm:pt-28 sm:pb-24 md:pt-36 md:pb-28">
          ...
          <div className="min-w-0">
            <Reveal>
              <div className="flex flex-wrap items-center gap-x-3 gap-y-2">
                <span className="stamp">v{stats.version} · beta</span>
            ...
            <Reveal delay={240}>
              <div className="mt-8 sm:mt-9 flex flex-col sm:flex-row sm:flex-wrap items-stretch sm:items-center gap-3">
                <a
                  href="#install"
                  className="group inline-flex items-center justify-center gap-2 rounded-full bg-foreground px-5 py-3 sm:py-2.5 t-btn text-background hover:opacity-90 transition-opacity"
                >
